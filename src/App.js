...
const INITIAL_ROOMS = [
  ...
  { id: 4, name: "G-7 AI Nexus Lab", category: "Lab", capacity: 72, currentAttendance: 0, status: "Available" },
  { id: 5, name: "G-13/14 Combined Lab", category: "Lab", capacity: 134, currentAttendance: 0, status: "Available" },
  { id: 6, name: "G-10 Seminar Hall 1", category: "Seminar Hall", capacity: 90, currentAttendance: 0, status: "Available" }
];
...
function App() {
  ...
  const executeAllocation = (id) => {
    ...
    if (remaining > 0) {
      ...
      setModal({ show: true, type: "success", message: `Full group allocated successfully!` });
      setRequestCount("");
      setHighlights([]);
    }
  };
